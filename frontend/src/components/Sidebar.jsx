...
// <<<<<<< HEAD
//     // --- 2. MENTOR MENU (Includes Review Submissions) ---
//     const mentorItems = [
//         { 
...
//         },
//         { 
//             id: 'review-submissions', label: 'Review Submissions', path: '/mentor/submissions', 
//             icon: 'M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0zM12 9v6' 
//         },
//         { 
...
// =======
  ...
  const mentorItems = [
    ...
    { 
      ...
      icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' // Checkmark circle icon
    },
    { 
      id: 'manage-students', 
      label: 'Students', 
      path: '/mentor/students', 
      icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' // Users group icon
    },
    { 
      id: 'referrals', 
      label: 'Referrals', 
      path: '/mentor/referral', 
      icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' // Trending up / Referral arrow
    },
    // ---------------------------------
    { 
      id: 'network', 
